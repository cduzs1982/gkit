...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x94, 0xd4, 0xb8, 0xb8, 0x3c, 0x40, 0xbc, 0xa0, 0xd4, 0x82, 0x9c, 0x4a, 0x21, 0x09, 0x2e, 0xf6,
	0xdc, 0xd4, 0xe2, 0xe2, 0xc4, 0xf4, 0x54, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x18, 0x57,
	0x49, 0x89, 0x8b, 0x07, 0xaa, 0xae, 0xb0, 0x34, 0xb5, 0xb8, 0x44, 0x48, 0x88, 0x8b, 0x25, 0x2f,
	0x31, 0x17, 0xa6, 0x0c, 0xcc, 0x36, 0x72, 0xe7, 0x62, 0x75, 0x2f, 0x4a, 0x4d, 0x2d, 0x11, 0xb2,
	0xe3, 0xe2, 0x08, 0x4e, 0xac, 0x04, 0xab, 0x17, 0x92, 0xd0, 0x43, 0xd8, 0xa6, 0x87, 0x6c, 0x84,
	0x94, 0x18, 0x16, 0x99, 0x82, 0x9c, 0x4a, 0x25, 0x06, 0x27, 0x61, 0x27, 0x7e, 0x30, 0x3f, 0x1c,
	0x24, 0x15, 0x00, 0x72, 0x73, 0x00, 0x63, 0x12, 0x1b, 0xd8, 0xf1, 0xc6, 0x80, 0x00, 0x00, 0x00,
	0xff, 0xff, 0xe8, 0xb0, 0x09, 0xc2, 0xcb, 0x00, 0x00, 0x00,
}
...
func (c *greetClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/helloworld.Greet/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreetServer) SayHello(ctx context.Context, req *HelloRequest) (*HelloReply, error) {
...
func _Greet_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greet/SayHello",
	}
